...
public class PlaceListAdapter extends RecyclerView.Adapter<PlaceListAdapter.PlaceViewHolder> {
    ...
    // DEPRECATED (3) Modify the Adapter to take a PlaceBuffer in the constructor
    // TODO (3) Modify the Adapter to take a List<Place>  in the constructor

    // DEPRECATED(4) Take a PlaceBuffer as an input and store it as a local private member mPlaces
    // TODO(4) Take a a List<Place> as an input and store it as a local private member mPlaces
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        ...
        holder.addressTextView.setText(mPlaces.get(position).getName());
    }
